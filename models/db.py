...
db.define_table('to_review',
    Field('tr_changelist','integer'),
    Field('tr_added','datetime',default=request.now),
    Field('tr_reporter_id','integer'),
    Field('tr_reviewed','datetime'),
    Field('tr_comment','string'),
    Field('tr_reviewer_id','integer'),
